...
```json
{
    "message": "Unable to generate documentation file to: \"C:\\Users\\gw_ak\\t\\tpIgl\\storage\\api-docs\/api-docs.json\". Please make sure directory is writable. Error: Required @OA\\Info() not found"
}
```
...
<!-- START_c73516dd30afa531e3d0847c84dda655 -->
## api/teacher/groupe
> Example request:

```bash
curl -X POST \
    "http://localhost/api/teacher/groupe" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
### HTTP Request
`POST api/teacher/groupe`


<!-- END_c73516dd30afa531e3d0847c84dda655 -->

<!-- START_547ca923d8d075668189a957e7e7eace -->
## api/teacher/groupe/addNote
> Example request:

```bash
curl -X POST \
    "http://localhost/api/teacher/groupe/addNote" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
### HTTP Request
`POST api/teacher/groupe/addNote`


<!-- END_547ca923d8d075668189a957e7e7eace -->

<!-- START_f462abd190d7d816dc85236f8261cdf9 -->
## api/student/modules
> Example request:

```bash
curl -X GET \
    -G "http://localhost/api/student/modules" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost/api/student/modules"
);
...
<!-- END_f462abd190d7d816dc85236f8261cdf9 -->
